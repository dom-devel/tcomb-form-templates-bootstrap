...
function create() {
  ...
  textbox.renderTextbox = overrides.renderTextbox || function renderTextbox(locals) {
    ...
    if (locals.type === "file") {
      ret = textbox.renderFileInput(locals);
    } else if (locals.type !== "textarea") {
      ret = textbox.renderInput(locals);
    } else {
      ret = textbox.renderTextarea(locals);
    }
  ...
  textbox.renderFileInput = overrides.renderFileInput || function renderFileInput(locals) {
    var filename = "Select a file.";
    console.log(locals);
    ...
    return _react["default"].createElement("div", {
    ...
    }, _react["default"].createElement("input", _extends({}, locals.attrs, {
      ...
      className: "file-label"
    }, "No file selected.")), _react["default"].createElement("span", {
      className: "file-name"
    }, filename)));
  };
